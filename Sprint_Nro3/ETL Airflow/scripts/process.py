...
def transform_data():
    ...
    if 'category' in df.columns:
        ...
        print("âš ï¸ La columna 'category' no existe en el DataFrame.")
        categories = pd.DataFrame(columns=['category', 'category_id'])

    # âœ… Solo hacer el merge si la columna existe
    if 'city' in df.columns:
